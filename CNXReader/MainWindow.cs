...
public partial class MainWindow : Gtk.Window
{
	...
	void InitTreeView()
	{
		...
		// Mãe
		var maeColumn = new SortableTreeViewColumn(5);
		maeColumn.Title = "Mãe";
		...
		// CPF
		var cpfColumn = new SortableTreeViewColumn(6);
		cpfColumn.Title = "CPF";
		...
		// CNS
		var cnsColumn = new SortableTreeViewColumn(7);
		cnsColumn.Title = "CNS";
		...
		// Data de Nascimento
		var dtNascimentoColumn = new SortableTreeViewColumn(8);
		...
		// Plano ANS
		var planoAnsColumn = new SortableTreeViewColumn(9);
		...
		var cnpjColumn = new SortableTreeViewColumn(10);
		...
		// Data Contratação
		var dtContratacaoColumn = new SortableTreeViewColumn(11);
		...
		// Data Cancelamento
		var dtCancelamentoColumn = new SortableTreeViewColumn(12);
		...
		// Data Reativação
		var dtReativacaoColumn = new SortableTreeViewColumn(13);
		...
		// Data Atualização
		var dtAtualizacaoColumn = new SortableTreeViewColumn(14);
		...
		// Ibge
		var ibgeColumn = new SortableTreeViewColumn(15);
		...
		// Bairro
		var bairroColumn = new SortableTreeViewColumn(16);
		...
		maeColumn.AddAttribute(maeNameCell, "text", 5);
		cpfColumn.AddAttribute(cpfNameCell, "text", 6);
		cnsColumn.AddAttribute(cnsNameCell, "text", 7);
		dtNascimentoColumn.AddAttribute(dtNascimentoCell, "text", 8);
		planoAnsColumn.AddAttribute(planoAnsNameCell, "text", 9);
		cnpjColumn.AddAttribute(cnpjNameCell, "text", 10);
		dtContratacaoColumn.AddAttribute(dtContratacaoNameCell, "text", 11);
		dtCancelamentoColumn.AddAttribute(dtCancelamentoNameCell, "text", 12);
		dtReativacaoColumn.AddAttribute(dtReativacaoNameCell, "text", 13);
		dtAtualizacaoColumn.AddAttribute(dtAtualizacaoNameCell, "text", 14);
		ibgeColumn.AddAttribute(ibgeNameCell, "text", 15);
		bairroColumn.AddAttribute(bairroNameCell, "text", 16);
	...
	bool FilterTree(TreeModel model, TreeIter iter)
	{
		...
		var mae = model.GetValue(iter, 5).ToString();
		var cpf = model.GetValue(iter, 6).ToString();
		var cns = model.GetValue(iter, 7).ToString();
		var dtNascimento = model.GetValue(iter, 8).ToString();
		var planoAns = model.GetValue(iter, 9).ToString();
		var cnpj = model.GetValue(iter, 10).ToString();
	...
	void Selection_Changed(object sender, EventArgs e)
	{
		...
		if (treeView.Selection.GetSelected(out selected))
		{
			informativeDetails.Text =
				  ...
				  $"Mãe: {(string)treeView.Model.GetValue(selected, 5)}\n" +
				  $"Última Atualização: {(string)treeView.Model.GetValue(selected, 14)}";
		}
	}
